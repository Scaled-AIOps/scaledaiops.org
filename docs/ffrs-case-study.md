...
| Respond | first response on the issue — the **FFRS agent** (GitHub Actions + Claude Code, every 30 min: PR on the site or a proposal) or a human comment; TTHR tracks the first *human* decision | GitHub comments API, `agent:*` labels |
